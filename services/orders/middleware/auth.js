...
/**
 * Middleware to check if user is accessing their own orders or is admin
 */
const requireOwnerOrAdmin = (req, res, next) => {
  ...
  // Allow if user is admin or accessing their own orders
  ...
  return res.status(403).json({
    error: 'access_denied',
    error_description: 'You can only access your own orders'
  });
};
